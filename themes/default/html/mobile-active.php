...
<td>
<input type="text"  placeholder="0912" name="MYNUM" style="text-align:left;border:solid 1px #c5c5c5;-moz-border-radius:6px;-webkit-border-radius:6px;border-radius:6px;height:35px;width:230px;font-size:25px;font-weight:bold;" value="'.decode_mobile_num($this->user->info->mobile_sms).'"/>
</td>
</tr>
</table>'
;
